...
if "release" in sys.argv[-1]:
    ...
    os.system("rm -rf dist/occultence*")
    sys.exit()

# a little kludge to get the version number from __version__
exec(open("occultence/version.py").read())
...
setup(
    ...
    description="Tools for cleaning and searching for transits in SPECULOOS lightcurves.",
    # what's a more detailed description?
    long_description="Read the complete documentation at ...",
    ...
    url="https://github.com/catrionamurray/occultence",
